...
from .views import HomeView, trips_list,TripCreateView,TripDetailView,NoteDetailView,TripUpdateView,TripDeleteView,NoteListView,NoteDeleteView,NoteCreateView,NoteUpdateView
